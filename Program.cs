...
ITransformer GenerateModel(MLContext mlContext)
{
    IEstimator<ITransformer> pipeline =
        mlContext.Transforms.LoadImages("input", imageFolder, nameof(ImageData.ImagePath))
            ...
            .Append(mlContext.Transforms.Conversion.MapValueToKey("PredictedLabelKey", "PredictedLabel"))
    ...
    MulticlassClassificationMetrics metrics =
        mlContext.MulticlassClassification.Evaluate(predictions, "LabelKey", "PredictedLabel");
